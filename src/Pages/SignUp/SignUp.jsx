        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto my-10 ">
            ...
            <form novalidate="" action="" className="space-y-6">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="email" id="full name" placeholder="enter email" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                </div>
                {/* password */}
                <div className="space-y-1 text-sm">
